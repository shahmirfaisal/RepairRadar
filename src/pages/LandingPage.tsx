...
const LandingPage = () => {
  ...
  return (
    <View backgroundColor="hsl(0deg 0% 96.37%)">
      ...
      <Grid
        templateColumns={{ base: "1fr", medium: "600px 500px" }}
        gap="20px"
        margin="50px auto"
        maxWidth="1300px"
        alignItems="center"
      ...
      >
        <View>
          ...
          <Text>
            Discover the Future of Vehicle Repairs with RepairRadar! We connect
            vehicle owners with skilled mechanics, making vehicle maintenance
            hassle-free and efficient. Our user-friendly app allows you to find
            nearby mechanics, view their profiles, and read genuine customer
            reviews and book appointments.
          </Text>
          <Button variation="primary" size="large" marginTop="20px">
            Get Started
          </Button>
        </View>
